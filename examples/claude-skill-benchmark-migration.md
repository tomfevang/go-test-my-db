...
go-test-my-db config, seeds data, runs query benchmarks, and suggests index improvements.

## Setup

### 1. Install go-test-my-db
...
cp -r <go-test-my-db>/examples/benchmark-migration .claude/skills/
```
...
4. **Creates** a go-test-my-db config with realistic data generators and benchmark queries
